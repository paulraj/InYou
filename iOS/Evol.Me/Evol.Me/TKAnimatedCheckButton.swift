...
public class TKAnimatedCheckButton : UIButton {
    ...
    public override init(frame: CGRect) {
        ...
        for layer in [ circle, check, self.shape ] {
            ...
            let strokingPath:CGPath = CGPathCreateCopyByStrokingPath(layer.path, nil, 4, .Round, .Miter, 4)!
            
            //let strokingPath:CGPath = CGPathCreateCopyByStrokingPath(layer.path, nil, 4, 0, 0, 4)!
